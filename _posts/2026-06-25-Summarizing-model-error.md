...
In the plot below, I normalized RMSE by the standard deviation so that variables with different ranges in variability could be compared to eachother. 

<img width="910" alt="image" src="https://github.com/user-attachments/assets/ac07bc75-a803-4c5b-9a88-33f03ba193ac" />

- Models have the least error for temperature (CT) as expected
- SalishSeaCast has the greatest error in South Sound
