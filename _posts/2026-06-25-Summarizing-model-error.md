...
In the plot below, I normalized RMSE by the standard deviation so that variables with different ranges in variability could be compared to eachother. I used the standard deviation of the observations across all basins. 
