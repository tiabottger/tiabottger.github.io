...
The following plots are a timeseries of the hypoxic volume and hypoxic area (the bottom grid cell area for cells <= 2mg) from 2015-2020 for loading runs including WWTPs. Next steps could be to further partition the data into subinlets.
