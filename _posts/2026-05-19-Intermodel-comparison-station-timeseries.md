...
Starting with dissolved oxygen (DO), we have bottle measurements at three main depths: -30.5 m, -11 m, and -1 m. In the property-property plots, LiveOcean performed worse than SalishSeaCast at depth whereas shallow values performed better. 

At the surface (-1 m), LiveOcean seems to track DO observations best. SalishSeaCast is biased low, although appears to predict DO better at Main Basin sites where it tracks very closely with LiveOcean results.
