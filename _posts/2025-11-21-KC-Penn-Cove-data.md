...
Profile casts (CT, DO, NO3, Chl, SA) processed by Dakota.   
Bottles at surface, 5m, bottom for nutrient concentrations (nitrate + nitrite, ammonia, orthophosphate, silica).   
...
## Questions
- Any work done with processing mooring data? Would it be useful for me to do this? 
Plots to make...   
Something like this but with LO and Whidbey High-Res model comparison: <img width="700" alt="image" src="https://github.com/user-attachments/assets/b1de4e51-a56f-4f10-aee8-2c06498b9f4a" />
